...
def command_from_name(command: str,
    ...
    commands: Dict[str, Callable[[str, Config], Command]] = {
        ...
        'compile-debug': CompileDebugCommand,
...
__commands = {
    ...
    'generate assembly',
    'compile':
    'compile a binary with full optimizations for profiling',
    'compile-debug':
    'compile a binary without optimization for debugging',
    'test':
    'run all test-* commands',
    'test-asan':
    'run tests with address sanitizer',
    'test-uninit':
    'run tests with automatic stack variables initialized',
    'test-plain':
    'run tests without any sanitizers',
    'benchmark':
    'alias for benchmark-all',
    'benchmark-all':
    'run benchmarks',
    'test-memcheck':
    'run all memcheck-* commands (except racecheck)',
    'test-memcheck-memcheck':
    'run tests and check for memory access errors and leaks',
    'test-memcheck-racecheck':
    'run tests and check for shared memory race conditions',
    'test-memcheck-initcheck':
    'run tests and check for uninitialized memory accesses',
    'test-memcheck-synccheck':
    'run tests and check for thread synchronization errors'
}
